                                ...
                                <div class="app-chat">
                                    <ul class="chat-users" style="height: calc(100vh - 400px)" data-simplebar>
                                        @foreach ($data as $item)
                                            <li>
                                                <a data-contact-name="{{ $item->name }}"
                                                    data-contact-city="{{ $item->city }}"
                                                    data-contact-country="{{ $item->country }}"
                                                    data-contact-description="{{ $item->description }}"
                                                    data-contact-phone="{{ $item->phone }}"
                                                    data-contact-location="{{ $item->location }}"
                                                    data-contact-designation="{{ $item->designation }}"
                                                    data-contact-company="{{ $item->company }}"
                                                    data-contact-location="{{ $item->location }}"
                                                    data-contact-email="{{ $item->email }}"
                                                    data-contact-image="{{ $item->image }}" href="javascript:void(0)"
                                                    class=" contact-list-details px-4 py-3 bg-hover-light-black d-flex align-items-center chat-user bg-light"
                                                    id="chat_user_1" data-user-id="1">
                                                    <span class="position-relative">
                                                        <img src="{{ asset('assets/images/contact_image/' . $item->image) }}"
                                                            alt="user-4" width="40" height="40"
                                                            class="rounded-circle">
                                                    </span>
                                                    <div class="ms-6 d-inline-block w-75">
                                                        <h6 class="mb-1 fw-semibold chat-title"
                                                            data-username="James Anderson">{{ $item->name }}</h6>
                                                        <span
                                                            class="fs-2 text-body-color d-block">{{ $item->email }}</span>
                                                    </div>
                                                </a>
                                            </li>
                                        @endforeach
                                                    ...
                                                    <div class="chat-list chat active-chat" data-user-id="1">
                                                        <div
                                                            ...
                                                            <div class="d-flex align-items-center gap-3">
                                                                <img src="../../dist/images/profile/user-4.jpg"
                                                                    ...
                                                                    class=" contact-image rounded-circle" />
                                                                <div>
                                                                    <h6 class=" contact-name fw-semibold fs-4 mb-0">Dr.
                                                                        Bonnie
                                                                        Barstow
                                                                    </h6>
                                                                    <p class=" contact-designation mb-0">Sales Manager</p>
                                                                    <p class="  contact-company mb-0">Digital Arc Pvt. Ltd.
                                                                    </p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-4 mb-7">
                                                                ...
                                                                <h6 class=" contact-phone fw-semibold mb-0">+1 (203) 3458
                                                                </h6>
                                                            </div>
                                                            <div class="col-8 mb-7">
                                                                <p class=" mb-1 fs-2">Email address</p>
                                                                <h6 class=" contact-email fw-semibold mb-0">
                                                                    alexandra@modernize.com
                                                                </h6>
                                                            </div>
                                                            <div class="col-12 mb-9">
                                                                <p class="mb-1 fs-2">Address</p>
                                                                <h6 class="contact-location fw-semibold mb-0">312,
                                                                    Imperical Arc, New
                                                                    western corner</h6>
                                                            </div>
                                                            <div class="col-4 mb-7">
                                                                <p class="mb-1 fs-2">City</p>
                                                                <h6 class="contact-city fw-semibold mb-0">New York</h6>
                                                            </div>
                                                            <div class="col-8 mb-7">
                                                                <p class="mb-1 fs-2">Country</p>
                                                                <h6 class="contact-country fw-semibold mb-0">United Stats
                                                                </h6>
                                                            </div>
                                                        </div>
                                                        <div class="border-bottom pb-7 mb-4">
                                                            <p class="mb-2 fs-2">Notes</p>
                                                            <p class=" contact-description mb-3 text-dark">
                                                                Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                                                                Quisque bibendum
                                                                hendrerit lobortis. Nullam ut lacus eros. Sed at luctus
...
@push('custom-scripts')
    <script>
        $(document).ready(function() {
            $('.contact-list-details').click(function() {
                const contactname = $(this).data('contact-name');
                const contactdesignation = $(this).data('contact-designation');
                const contactdescription = $(this).data('contact-description');
                const contactcompany = $(this).data('contact-company');
                ...
                $('.contact-designation').text(contactdesignation);
                $('.contact-description').text(contactdescription);
                $('.contact-company').text(contactcompany);
                $('.contact-city').text(contactcity);
