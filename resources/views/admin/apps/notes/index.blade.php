                                        ...
                                        <td style="text-align:right;">
                                            <form id="edit{{ $item->id }}"
                                                ...
                                                <button type="button"
                                                    ...
                                                    <i class="ti ti-pencil" data-bs-toggle="tooltip" data-bs-placement="top"
                                                        title="Edit"></i>
                                                </button>
                                                @csrf
                                                ...
                                                <button type="button" id="delete{{ $item->id }}"
                                                    ...
                                                    data-bs-placement="top" title="Delete"><i class="ti ti-trash"></i>
                                                </button>
                                            </form>
                                        </td>
                                    </tr>
