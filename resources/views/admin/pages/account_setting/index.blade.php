                      ...
                      <div class="card w-100 position-relative overflow-hidden">
                        <div class="card-body p-4">
                          ...
                          <form>
                            ...
                            <div class="mb-4">
                              <label for="exampleInputPassword1" class="form-label fw-semibold">{{$user->password}}</label>
                              <input type="password" class="form-control" id="exampleInputPassword1" value="12345678910">
                            </div>
                            <div class="">
                              <label for="exampleInputPassword1" class="form-label fw-semibold">{{$user->password}}</label>
                          ...
                          <form>
                            <div class="row">
                              <div class="col-lg-6">
                                ...
                                <div class="mb-4">
                                  <label for="exampleInputPassword1" class="form-label fw-semibold">{{$user->email}}</label>
                              ...
                              <div class="col-lg-6">
                                ...
                                <div class="mb-4">
                                  <label for="exampleInputPassword1" class="form-label fw-semibold">{{$user->phone}}</label>
                                  <input type="text" class="form-control" id="exampleInputtext" placeholder="+91 12345 65478">
                                </div>
                              </div>
                              <div class="col-12">
                                <div class="">
                                  <label for="exampleInputPassword1" class="form-label fw-semibold">{{$user->address}}</label>
