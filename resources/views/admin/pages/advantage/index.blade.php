        ...
        <div class="col-md-12 mt-5">
            ...
            <div class="card card-body mt-5">
                <div class="row mt-5">
                    ...
                    @include('admin.pages.advantage.create')
                    <div
                        ...
                        <a href="javascript:void(0)" data-toggle="modal" data-target="#AddBanner"
                            class=" banner btn btn-primary float-end btn-sm"><i
                                class="ti ti-users text-white me-1 fs-5"></i>Add Advantages</a>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <table class="table search-table align-middle text-nowrap table-bordered data-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                              ...
                              <td>
                                  @if($item->image)
                                       <img src="{{ asset('assets/images/advantage_image/' . $item->image) }}" alt="" width="70" height="70">
                                  @else
                              ...
                              <td>
                                ...
                                <td style="text-align:right;">
                                    <form id="edit{{ $item->id}}" action="{{ route('admin.banner.destroy', $item->id) }}">
                                        <button type="button"
                                            onclick="editForm('{{ route('admin.advantage.edit', $item->id) }}', 'edit')"
