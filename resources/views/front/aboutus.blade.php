...
@section('SEO')
    <meta name="description"
        content="For schools and teachers, Mold the Future offers specialized services. We have an intense affection for the academic community.
">
@endsection
                    ...
                    <div class="col-xxl-12">
                        <div class="certificate__content text-center">
                            <div class="section__title-wrapper mb-10">
                                <h1 class="section__title section__title-44 mb-20 text-white"> You can be your own</br>
                                    Guiding star with the help of MoldTheFuture </h1>
                            </div>
