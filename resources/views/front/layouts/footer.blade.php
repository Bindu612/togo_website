   <!-- footer area start -->
   <footer>
    <div class="footer__area mt-20">
        <div class="footer__top tp-common-black pt-45">
            <div class="container">
                <div class="row">
                    <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6 col-sm-7">
                        <div class="footer__widget footer__widget-2 footer-col-2-1">
                            <div class="footer__logo">
                                <div class="logo">
                                    <a href="#">
                                        <img src="assets/img/logo/moldthefuture-white-logo.png" alt="" style="    width: 250px;">
                                    </a>
                                </div>
                            </div>
                            <div class="footer__widget-content">
                                <div class="footer__widget-info">
                                    <h5 class="lh-base text-gray">As we envision, Moldthefuture is completely
                                        looking to change the user experiences and institution management experience
                                    </h5>
                                    <div class="footer__social pt-10">
                                        <h4 class="text-white">Follow Us</h4>

                                        <ul>
                                            <li><a href="https://www.facebook.com/profile.php?id=61550925572834" target="_blank"><i class="fa-brands fa-facebook-f"></i></a></li>
                                            <li><a href="https://instagram.com/_moldthefuture?igshid=NjIwNzIyMDk2Mg==" target="_blank"><i class="fa-brands fa-instagram"></i></a></li>
                                            <li><a href="https://www.linkedin.com/company/100742223/admin/feed/posts/" target="_blank"><i class="fa-brands fa-linkedin-in"></i></a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="footer__widget footer__widget-2 footer-col-2-3">
                            ...
                            <div class="footer__widget-content">
                                <ul>
                                    ...
                                    <li>
                                        <a href="terms.php"> Terms of Website Use</a>
                                    </li>
                                    <li>
                                        <a href="term-website.php"> Terms & Conditions</a>
                                    </li>
                                    <!-- <li>
                    ...
                    <div class="col-xxl-4 col-xl-4 col-lg-4 col-md-6 col-sm-7">
                        <div class="footer__widget footer__widget-2 footer-col-2-4">
                            <h3 class="footer__widget-title">Sign up for our newsletter</h3>
                            <div class="footer__subscribe">
                                <p class="text-white">Sign up and receive the latest tips via email.
                    ...
                    <div class="row">
                        <div class="col-xxl-12">
                            <div class="footer__copyright text-center">
                                <p class="text-white fw-lighter">© 2022 <a href="http://Moldthefuture.com/Moldthefuture/">Moldthefuture</a>. All
                                    Rights Reserved Powered By <a href="https://togoteams.com/">TogoTeams</a></p>
                            </div>
                        </div>
                    </div>
                </div>
