                    ...
                    <div class="contact__info white-bg p-relative z-index-1">
                        ...
                        <div class="contact__info-inner white-bg">
                                    ...
                                    <li>
                                        <div class="contact__info-item d-flex align-items-start mb-35">
                                            ...
                                            <div class="contact__info-text">
                                                ...
                                                <p><a target="_blank" href="https://maps.app.goo.gl/EyBsNE2TSKXKbxrf8">
                                                        {{ $setting->address }}</a></p>
                                    ...
                                    <li>
                                        <div class="contact__info-item d-flex align-items-start mb-35">
                                            ...
                                            <div class="contact__info-text">
                                                ...
                                                <p><a href="mailto:info@Moldthefuture.com"><span class="__cf_email__"
                                                            data-cfemail="493a3c3939263b3d092c2d3c222c3b672a2624">{{ $setting->email1 }}</span></a>
                                                </p>
                                                <p><a href="mailto:info@Moldthefuture.com"><span class="__cf_email__"
                                                            data-cfemail="493a3c3939263b3d092c2d3c222c3b672a2624">{{ $setting->email2 }}</span></a>
                                                </p>
                            ...
                            <div class="contact__social pl-30">
                                <h4>Follow Us</h4>
                                <ul>
                                    <li><a href=" https://www.facebook.com/profile.php?id=61550925572834" class="fb"
                                            target="_blank"><i class="fa-brands fa-facebook-f"></i></a></li>
                                    <li><a href="https://www.linkedin.com/company/100742223/admin/feed/posts/"
                                            class="tw" target="_blank"><i class="fa-brands fa-linkedin"></i></a></li>
                                    <li><a href="https://instagram.com/_moldthefuture?igshid=NjIwNzIyMDk2Mg=="
                                            class="tw" target="_blank"><i class="fa-brands fa-instagram"></i></a>
                                    </li>
